...
- **Storage:** Longhorn (RF=2) for PostgreSQL and InfluxDB PVCs; daily local snapshots + manual off-cluster backups to an NFS export on the operator's Mac (see `DEPLOYMENT.md` "Off-cluster backups (Longhorn BackupTarget)", #64)
