...
- **Storage:** Longhorn (RF=2) for PostgreSQL and InfluxDB PVCs; daily local Longhorn snapshots + manual app-data dumps to the operator's Mac (`DEPLOYMENT.md` "App-data backups to the operator's Mac", #64)
