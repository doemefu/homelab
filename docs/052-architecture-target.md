...
- **Storage:** Longhorn (RF=2) for PostgreSQL and InfluxDB PVCs; daily local snapshots + daily off-cluster backups to Cloudflare R2 (see `DEPLOYMENT.md` "Off-cluster backups (Longhorn BackupTarget)", #64)
