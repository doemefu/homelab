...
**raspi4 joins the gate on 2026-09-25** (amended 2026-09-25, homelab#118), so the gate now covers all four nodes. It joins after 12 h of mba2 observation: mba2 had a 12 h max working set of 349 MiB (steady 332 MiB, RSS 63 MiB), 0 restarts and no OOMKilled; raspi5 peaked at 442 MiB and mba1 at 390 MiB. raspi4 has the least headroom (3 785 Mi allocatable, 1 736 Mi or 45 % used, about 2 GB free). Its expected startup peak on the arm64 Pi is about 400–500 MiB (raspi5 measured 479 MiB), under the 1Gi limit.
...
| Q4 | ~~Go for the coroot spike, then for the all-node rollout~~ — closed: the spike and mba2 go were given on 2026-09-24, and raspi4 joined on 2026-09-25 | **NM-2 (blocker)** | — (owner action) |
