...
- **Privileged DaemonSet.** coroot-node-agent runs privileged with hostPID in `monitoring`. It was explicitly approved by the owner, and the rollout needs a go after the spike.
